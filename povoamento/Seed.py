...
# ---------------------------------------------------------
# CONFIGURAÇÃO DE CAMINHOS (ajustada à nova estrutura)
# ---------------------------------------------------------

# Pasta base do projeto: /pasta-do-projeto
BASE_DIR = Path(__file__).resolve().parents[1]

DATA_DIR = BASE_DIR / "data"
INTERFACE_DIR = BASE_DIR / "interface"

DB_PATH = INTERFACE_DIR / "contratos_publicos.db"
EXCEL_PATH = DATA_DIR / "ContratosPublicos2024.xlsx"
